...
//Obtenemos y formateamos las horas

//Formateamos las horas con el formato que tienen en la base de datos
timeopen= formatime (timeopen);
timefinish= formatime (timefinish);
